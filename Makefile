...
deps:
	sudo apt update
	sudo apt install libc6-armel-cross libc6-devarmel-cross binutils-arm-linux-gnueabi libncurses5-dev \
		build-essential bison flex libssl-dev bc gcc-arm-linux-gnueabi ninja
